...
public class SysConsoleLog {
    ...
    public SysConsoleLog(String level, String message, String source, String metadata) {
    ...
    public SysConsoleLog(int id, String level, String message, String source,
